...
const createAppointment = {
  body: Joi.object().keys({
    ...
    downPayment: Joi.string().allow('').optional(),
    transactionReferenceNo: Joi.string().allow('').optional(),
...
const updateAppointment = {
  ...
  body: Joi.object()
    .keys({
      ...
      downPayment: Joi.string().allow(''),
      transactionReferenceNo: Joi.string().allow(''),
